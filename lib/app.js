...
const app = {
  ...
  config: {
    ...
    monitor_delay: 5, // Delay in seconds after which monitor will be stared
    ...
    watchdog_shares_interval: 180, // How often watchdog will check for failures for shares monitoring [s]
    watchdog_gpu_shares_interval: 900, // How often watchdog will check for invalid shares [s] 15m by default
    watchdog_gpu_shares_restart: 1, // Should restart miner if per gpu shares are not increasing
    watchdog_delay: 60, // How to watchdog will wait for startup and after restart [s]
